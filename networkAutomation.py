...
#
# # dist subnet source
# with serial.Serial(port='COM4') as rout:
#     rout.write(b'ip route 192.168.10.5 255.255.255.0 10.1.1.1 ')
# with serial.Serial(port='COM5') as rout:
#     rout.write(b'ip route 10.1.1.5 255.255.255.0 192.168.10.1')
#
#
